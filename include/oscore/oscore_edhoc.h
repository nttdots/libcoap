...
coap_binary_t *
edhoc_create_message_3(edhoc_ctx_t *edhoc_ctx, coap_bin_const_t *message_2);
...
oscore_ctx_t *
edhoc_read_message_4(coap_context_t *ctx, cose_alg_t hkdf_alg, coap_string_t *message_1, coap_string_t *message_2, coap_string_t *message_3, coap_string_t *message_4);
