...
t_oscore_c_7(void) {
 ...
 static const uint8_t protected_coap_response[] =
  ...
  CU_ASSERT_PTR_NOT_NULL(incoming_pdu);
  CU_ASSERT_PTR_NOT_NULL(pdu);
...
t_oscore_c_7_2(void) {
 ...
 static const uint8_t protected_coap_response[] =
  ...
  CU_ASSERT_PTR_NOT_NULL(outgoing_pdu);
  CU_ASSERT_PTR_NOT_NULL(incoming_pdu);
...
/*
 * 3.1 Initiator create DH EDHOC message_1
 */
static void
t_edhoc_dh_c_m1(void)
{
 static const char conf_data[] =
    /* 0x0c + bias 24 = 0x24 */
    "recipient_id,hex,\"24\"\n"
...
/*
 * 3.2 Responder create DH EDHOC message_2
 */
static void
...
#if HAVE_OSCORE_EDHOC
  suite[1] = CU_add_suite("OSCORE EDHOC", NULL, NULL);
